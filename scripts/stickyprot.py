...
def main(args):
    ...
    for cycle in range(1, num_cycles+1):
        ...
        poses = ligandmpnn_runner.run(
            ...
            model_type="soluble_mpnn",
            options=f"--chains_to_design A,C --symmetry_residues {symmetry_res} --symmetry_weights {symmetry_weights} --checkpoint_soluble_mpnn /home/mabr3112/LigandMPNN/model_params/solublempnn_v_48_020.pt",
            overwrite=False
        )
